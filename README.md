...
本仓库是可下载的科研辅助工作区：包含主引导 skill、九个固定版本科研 skills 及一个共享支持包、三个专家子 agent 配置和空白模板。它需要支持文件与工具的 AI 客户端运行，不是独立网页应用。
...
- `vendor/skills/`：九个固定提交版本的第三方科研技能及 nature-shared 支持包
