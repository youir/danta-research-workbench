...
本仓库是可下载的科研辅助工作区：包含龚博士的主引导 skill、九个固定版本科研 skills、女娲专家蒸馏 skill、可选专家角色配置和空白模板。它需要支持文件与工具的 AI 客户端运行，不是独立网页应用。扩展包不要求新使用者安装。
...
![龚博士科研工作台最新框架图：单一对话入口、三条工作路径、唯一私有研究档案](docs/assets/architecture.png)
