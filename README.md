...
**思维优先，决策在人。** 主 agent 是龚博士博士期间的持续科研助理与思考搭档：在她授权的工作区逐步了解资料和协作偏好，延续研究脉络，再通过倾听、追问、证据与不同解释帮助她形成自己的科学问题。

本仓库是可下载的科研辅助工作区：包含主引导 skill、九个固定版本科研 skills 、女娲专家蒸馏 skill 及一个共享支持包、三个专家子 agent 配置和空白模板。它需要支持文件与工具的 AI 客户端运行，不是独立网页应用。

## Obsidian 科研知识库（推荐新使用者）

已有 Obsidian 可直接使用 [科研知识库指南](09_科研知识库与Obsidian.md)：00–14 中英文目录、分层索引、13类笔记模板、实验与分析追溯，以及有来源的长期记忆。初始化会创建独立私有 vault；旧工作台继续可用，二选一作为当前研究位置。
