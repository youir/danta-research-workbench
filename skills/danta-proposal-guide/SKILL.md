...
若生物研究请求触发平台安全审查，立即按 [biosafety-escalation.md](references/biosafety-escalation.md) 处理：暂停被审查部分、仅在授权私有库写入脱敏连续性记录、继续与其可分离的安全工作，并可协助核验官方研究人员可信访问申请。不得把审查提示作为换模型、打开 KimiWork、上传记忆文档或以其他方式续做同一受限任务的触发器。
